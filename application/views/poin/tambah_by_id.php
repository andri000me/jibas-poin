                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>poin/tambah_by_id">
                                <div class="card-body">
                                    <input type="hidden" name="siswa_id" value="<?php echo $siswa->id ?>" />
                                    <div class="form-group row">
                                        <label for="tgl_poin" class="col-sm-3 col-form-label">Rombel</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" disabled value="<?php echo $siswa->nama_rombel ?>"></input>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tgl_poin" class="col-sm-3 col-form-label">Nama Siswa</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" disabled value="<?php echo $siswa->nama ?>"></input>
                                        </div>
                                    </div>
                                    <div class=" form-group row">
