                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $jumlah_gtk_jibas ?></td>
                                        <td><?php echo $jumlah_gtk_aplikasi ?></td>
                                        <td>
                                            <?php echo $jumlah_gtk_aplikasi >= $jumlah_gtk_jibas ? '<span class="badge bg-success">lengkap</span>' : '<span class="badge bg-primary">kurang</span>'; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>4.</td>
